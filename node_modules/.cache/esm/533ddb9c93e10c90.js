let pptxgen,jsPDF,express,exporter;_93e‍.w("pptxgenjs",[["default",["pptxgen"],function(v){pptxgen=v}]]);_93e‍.w("jspdf",[["jsPDF",["jsPDF"],function(v){jsPDF=v}]]);_93e‍.w("express",[["default",["express"],function(v){express=v}]]);_93e‍.w("highcharts-export-server",[["default",["exporter"],function(v){exporter=v}]]);
...
const PORT = 8000
app.listen(8000, () => {
  _93e‍.g.console.log("server running on port " + PORT);
});
...
const exportToPDF = (imgArrayBase64)=>{
    ...
    _93e‍.g.console.log(dimensions.width, dimensions.height);
